...
class EmployeeBossAdminController extends RestfulController  {

    static responseFormats = ['html']
    def baseService
    static scaffold = EmployeeBoss

    EmployeeBossAdminController() {
        super(EmployeeBoss)
    }

    @Override
    protected EmployeeBoss createResource() {
        EmployeeBoss instance = new EmployeeBoss()
    ...
    def update() {
        ...
        EmployeeBoss instance = queryForResource(params.id)
        if (instance == null) {
            notFound()
            return
        }
