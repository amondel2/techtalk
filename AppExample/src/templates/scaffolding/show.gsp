...
<html>
	...
	<body>
		...
		<div id="show-${domainClass.propertyName}" class="content scaffold-show" role="main">
			...
			<g:form url='[controller:"\${entityName}Admin", id:"\${${propertyName}.id}", action:"delete"]' method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" controller="\${entityName}Admin" id="\${${propertyName}.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
