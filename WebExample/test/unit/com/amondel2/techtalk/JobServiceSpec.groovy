...
class JobServiceSpec extends Specification {
	...
	[['name':"Some Name",'id':"12313213",'employees':['item']]] 	|	[['id':"12313213", 'text':"Some Name", 'children':true, 'childType':'employee']]
	[['name':"",'id':"12313213",'employees':['item']]] 	|	[['id':"12313213", 'text':"", 'children':true, 'childType':'employee']]
	[['name':"Some Name",'id':"12313213",'employees':[]]]	|	[['id':"12313213", 'text':"Some Name", 'children':false, 'childType':'employee']]
	[['name':"Some Name",'id':"12313213"]]	|	[['id':"12313213", 'text':"Some Name", 'children':false, 'childType':'employee']]
    }
    
    void "test update Call"() {
	given:
	mockServer.expect(requestTo(url + "/jobs/" + jsonResult.id))
