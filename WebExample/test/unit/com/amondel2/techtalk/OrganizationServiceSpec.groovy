...
class OrganizationServiceSpec extends Specification {
	...
	[['name':"Some Name",'id':"12313213",'jobs':['item']]] 	|	[['id':"12313213", 'text':"Some Name", 'children':true, 'childType':'job']]
	[['name':"",'id':"12313213",'jobs':['item']]] 	|	[['id':"12313213", 'text':"", 'children':true, 'childType':'job']]
	[['name':"Some Name",'id':"12313213",'jobs':[]]]	|	[['id':"12313213", 'text':"Some Name", 'children':false, 'childType':'job']]
	[['name':"Some Name",'id':"12313213"]]	|	[['id':"12313213", 'text':"Some Name", 'children':false, 'childType':'job']]
    }

    void "test update Call"() {
	given:
	mockServer.expect(requestTo(url + "/organization/" + jsonResult.id))
    ...
    void "test save Call"() {
	given:
	mockServer.expect(requestTo(url + "/organization/"))
	...
	where:
	jsonResult | resultText
	['name':'joe','parentId':'32432432'] | ["burt":"rendols"]
    }
